...
This repository contains the manuscript sources for a master thesis project. and the analysis code used to recast published axion-haloscope limit data into constraints on millicharged dark matter. C and power.ipynb also compute the mDM response to different cavity modes of a circular cylindrical cavity.
